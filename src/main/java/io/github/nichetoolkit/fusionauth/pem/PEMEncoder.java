...
/**
 * <code>PEMEncoder</code>
 * <p>The pem encoder class.</p>
...
public class PEMEncoder {
  ...
  /**
   * <code>parseEncodedCertificate</code>
   * <p>The parse encoded certificate method.</p>
   * @param derEncoded {@link java.lang.String} <p>The der encoded parameter is <code>String</code> type.</p>
   * @return {@link java.lang.String} <p>The parse encoded certificate return object is <code>String</code> type.</p>
